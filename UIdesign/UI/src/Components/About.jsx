  ...
  return (
    <div className="w-full">
      ...
      <div className="max-w-6xl mx-auto px-4 mt-6">
        ...
        <div className="bg-white shadow-lg p-6 text-justify text-[17px]">
          <p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6 text-orange-600">
        ...
        {/* Courier Section */}
        <h1 className="text-center text-3xl font-bold text-red-900 mt-16 mb-6">
        ...
        <div className="bg-white shadow-lg p-6 text-justify text-[17px] mb-15">
          <p>
